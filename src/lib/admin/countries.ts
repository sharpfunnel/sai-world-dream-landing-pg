// ISO 3166-1 alpha-2 -> country name, for labeling Visitor.country (which stores the
// ISO-2 code straight from Vercel's geolocation() / x-forwarded-for geo lookup).
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  VE: "Venezuela", VN: "Vietnam", VG: "British Virgin Islands", VI: "U.S. Virgin Islands", YE: "Yemen",
